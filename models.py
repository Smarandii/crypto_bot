from content import BASE_STATUS, BOT_TAG
...
class User:
    def __init__(self, db_id=None, telegram_id=None, balance=0, status=BASE_STATUS, is_follower=None, invited_by=0,
...
class MessageParser:
    ...
    def get_command_value(self, message):
        command, command_value = message.text.split(" ")
