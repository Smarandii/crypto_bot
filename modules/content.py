...
class BotContent:
    ...
    REPLENISH_METHODS = {
        'pay_sber_replenish': 'Сбербанк ',
        'pay_yandex_replenish': 'Yandex ',
        'pay_advcash_replenish': 'AdvCash ',
    }
    ...
    MESSAGES = {
        ...
        'replenish_cancel_warning': 'Если вы уже перевели деньги по указанным реквизитам, то деньги уже не вернуть\n'
                                    'Вы уверены, что хотите отменить заявку?',
